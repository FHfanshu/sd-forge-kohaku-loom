...
def _require_windows() -> None:
    if os.name != "nt":
        raise RuntimeError("Kohaku Loom managed secrets require Windows DPAPI")
...
def protect_text(value: str, entropy: str = "kohaku-loom") -> str:
    _require_windows()
...
def unprotect_text(value: str, entropy: str = "kohaku-loom") -> str:
    _require_windows()
    crypt32, kernel32 = _libraries()
